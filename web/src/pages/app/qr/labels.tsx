            ...
            <div className="card no-print" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
              ...
              <div className="row" style={{ gap: 8, flexWrap: 'wrap' }}>
                <select className="select" value={template} onChange={(e) => setTemplate(Number(e.target.value) as TemplateKey)}>
                  <option value={10}>A4 라벨 10칸(2x5)</option>
                  <option value={12}>A4 라벨 12칸(2x6)</option>
                  <option value={14}>A4 라벨 14칸(2x7)</option>
                </select>
                ...
                <Link className="btn secondary" href="/app/qr">목록</Link>
              </div>
            </div>
            ...
            {!loading && labels.length === 0 && (
              <div className="card">
                ...
                <div className="muted" style={{ fontSize: 13 }}>
                  예: <code>/app/qr/labels?ids=12,13</code> 또는 <code>/app/qr/labels?mode=today</code>
                </div>
              </div>
            )}
